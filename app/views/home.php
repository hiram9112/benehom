...
<script<?= bh_nonce_attr() ?>>
    ...
    for (var i = 0; i < els.length; i++) {
        ...
        $bhHomeDescription = 'BeneHom te ayuda a entender tus gastos, descubrir tu margen real, probar decisiones con números y resolver dudas con Numa, su asistente integrado.';
        $bhHomeJsonLd = [
            [
        ...
        <main id="contenido">
                ...
                <div class="bh-home-wrap">
                    ...
                    <div class="bh-home-benefits-grid">
                        ...
                        <article class="bh-home-benefit bh-reveal">
                            ...
                            <p>Aprende conceptos financieros indispensables con ejemplos cercanos y pregunta a Numa cuando necesites una explicación sin jerga.</p>
                        </article>
                    </div>
                </div>
            </section>
            ...
            <!-- ============================ Numa ============================ -->
            <section class="bh-home-numa" id="numa" aria-labelledby="numa-title">
                <div class="bh-home-wrap">
                    <div class="bh-home-numa-layout">
                        <div class="bh-home-numa-copy">
                            <div class="bh-home-numa-eyebrow" aria-label="Numa, asistente integrado en fase beta">
                                <span class="bh-home-numa-context">AISTENTE CON IA INTEGRADA</span>
                                <span class="bh-home-numa-beta">FASE BETA</span>
                            </div>
                            <h2 id="numa-title">Pregúntale a Numa y entiende mejor tus números.</h2>
                            <p class="bh-home-numa-lead"><span>Numa es el asistente inteligente de BeneHom. Utiliza inteligencia</span> <span>artificial para ayudarte a entender mejor tus finanzas, explicar</span> <span>conceptos y orientarte dentro de la aplicación. Con la sesión</span> <span> iniciada, interpreta tus ingresos y gastos, compara</span> <span> períodos, calcula promedios y</span> <span>detecta tendencias.</span></p>

                            <div class="bh-home-numa-actions">
                                <button
                        ...
                        <figure class="bh-home-numa-stage bh-reveal" aria-labelledby="numa-demo-title">
                            <div class="bh-home-numa-demo-frame">
                                <div class="bh-home-numa-demo-head">
                                    <div>
                                        <span>Ejemplo de conversación</span>
                                        <h3 id="numa-demo-title">Una consulta, varios períodos</h3>
                                    </div>
                                    <span>Septiembre de 2026 · Datos sintéticos</span>
                                </div>

                                <div class="bh-home-numa-demo" aria-label="Conversación de demostración con Numa">
                                    <div class="bh-home-numa-message is-user">
                                        <p>Compara mis gastos flexibles de este mes con mi promedio de los últimos 6 meses y dime qué categoría explica más la diferencia.</p>
                                    </div>
                                    <div class="bh-home-numa-message is-assistant">
                                        <p>Este mes llevas 445&nbsp;€ en gastos flexibles, frente a una media de 360&nbsp;€ en los últimos 6 meses: 85&nbsp;€ más (+24&nbsp;%).</p>
                                        <p>La mayor diferencia viene de comida a domicilio, donde has gastado 62&nbsp;€ más de lo habitual. El resto de categorías se mantiene cerca de tu promedio.</p>
                                    </div>
                                </div>

                                <div class="bh-home-numa-demo-privacy">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                        <rect x="5" y="10" width="14" height="10" rx="2" />
                                        <path d="M8 10V7a4 4 0 0 1 8 0v3" />
                                    </svg>
                                    <p>Accede de forma segura y controlada solo a los movimientos necesarios para responder.</p>
                                </div>
                            </div>
                            <img
                                class="bh-home-numa-character"
                                src="<?= htmlspecialchars(bh_asset('img/numa/numa-static-sm.webp'), ENT_QUOTES, 'UTF-8') ?>"
                                alt=""
                                width="384"
                                height="384"
                                loading="lazy"
                                decoding="async">
                            <figcaption class="visually-hidden">Demostración visual, no interactiva, de una comparación realizada por Numa con información ficticia.</figcaption>
                        </figure>
                    </div>

                    <div class="bh-home-numa-benefits" aria-label="Qué aporta Numa">
                        <article class="bh-home-numa-benefit bh-reveal">
                            <span class="bh-home-numa-benefit-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                    <path d="M5 5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-6l-4 4v-4a2 2 0 0 1-2-2z" />
                                    <path d="M9 8h6M9 12h4" />
                                </svg>
                            </span>
                            <div>
                                <h3>Pregunta con tus palabras</h3>
                                <p>Aclara cómo funciona BeneHom y conceptos financieros con explicaciones directas.</p>
                            </div>
                        </article>
                        <article class="bh-home-numa-benefit bh-reveal">
                            <span class="bh-home-numa-benefit-icon">
                            ...
                            <div>
                                <h3>Pon tus datos en contexto</h3>
                                <p>Compara periodos y categorías, calcula promedios e identifica qué explica cada cambio.</p>
                            </div>
                        </article>
                        <article class="bh-home-numa-benefit bh-reveal">
                            <span class="bh-home-numa-benefit-icon">
                            ...
                            <div>
                                <h3>Solo la información necesaria</h3>
                                <p>Usa tus datos de forma segura y controlada, evitando compartir información innecesaria con terceros.</p>
                            </div>
                        </article>
                    </div>
                </div>
            ...
            <section class="bh-home-features" id="funciones" aria-labelledby="features-title">
                <div class="bh-home-wrap">
                    <div class="bh-home-section-head">
                        ...
                        <p>Herramientas que trabajan juntas: registrar, comparar, proyectar, preguntar y ver la evolución. Cada una integrada en el mismo sitio.</p>
                    </div>
            ...
            <section class="bh-home-faq" id="faq" aria-labelledby="faq-title">
                <div class="bh-home-wrap">
                    ...
                    <div class="bh-home-faq-list">
                        ...
                        <details class="bh-home-faq-item">
                            <summary>¿Qué puede hacer Numa y qué límites tiene?</summary>
                            <p>Numa es el asistente integrado de BeneHom. Puede explicar cómo funciona la aplicación y conceptos financieros; con la sesión iniciada, también interpreta y compara tus ingresos, gastos y movimientos registrados. Accede de forma segura y controlada solo a la información necesaria para responder, no modifica tus datos y evita compartir información innecesaria con terceros. Está en beta, tiene límites de uso y sus respuestas son orientativas.</p>
                        </details>
                        <details class="bh-home-faq-item">
