...
<head>
    ...
    <meta property="og:title" content="<?= htmlspecialchars($documentTitle, ENT_QUOTES, 'UTF-8') ?>">
    ...
    <meta name="twitter:title" content="<?= htmlspecialchars($documentTitle, ENT_QUOTES, 'UTF-8') ?>">
