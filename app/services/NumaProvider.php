    ...
    private const FINANCIAL_RESULT_SCHEMAS = [
        'consultar_datos_financieros' => [
            ...
            'meses' => [[
                ...
                'ingresos' => [
                    'importe' => true,
                    'cobertura' => ['completa' => true, 'areas_consultadas' => true, 'areas_totales' => true],
                    'areas' => [[
                        'area' => true,
                        'importe' => true,
                        'cobertura' => ['completa' => true, 'categorias_consultadas' => true, 'categorias_totales' => true],
                        'categorias' => [['categoria' => true, 'importe' => true]],
                    ]],
                ],
                'gastos' => [
                    'importe' => true,
                    'cobertura' => ['completa' => true, 'tipos_consultados' => true, 'tipos_totales' => true],
                    'tipos' => [[
                        'tipo' => true,
                        'importe' => true,
                        'cobertura' => ['completa' => true, 'areas_consultadas' => true, 'areas_totales' => true],
